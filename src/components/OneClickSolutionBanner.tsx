      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-emerald-950 uppercase tracking-tighter mb-4 leading-[0.9]">
              Need <span className="italic">Immediate</span> <br className="md:hidden" /> Help?
            </h2>
            <p className="text-emerald-900 font-black uppercase tracking-widest text-xs md:text-sm opacity-80">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
             <a 
               ...
               className="flex items-center justify-center gap-3 bg-emerald-950 text-white px-8 py-5 rounded-2xl font-black text-lg shadow-2xl hover:scale-105 transition-all"
             >
             ...
             <a 
               ...
               className="flex items-center justify-center gap-3 bg-white text-emerald-950 px-8 py-5 rounded-2xl font-black text-lg shadow-2xl hover:bg-emerald-50 transition-all"
             >
