  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative bg-[#25D366] text-white p-4 md:p-5 rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.5)] flex items-center justify-center border-4 border-white group-hover:rotate-12 transition-transform duration-500">
