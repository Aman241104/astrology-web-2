      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-20 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-4 bg-[#25D366] hover:bg-emerald-950 text-white px-10 py-4 rounded-full font-bold text-lg shadow-xl transition-all hover:scale-105 active:scale-95 group"
          >
            <span>WhatsApp for Free Advice</span>
