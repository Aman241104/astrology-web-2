...
export default function LoveProblemBanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-emerald-950 py-8 md:py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16">
           ...
           <div className="w-full max-w-[450px] lg:max-w-[500px] relative group order-2 lg:order-1">
              ...
              >
                 ...
                 <div className="absolute bottom-6 left-6 bg-gold text-emerald-950 px-4 py-1 rounded-full font-black text-[10px] uppercase tracking-widest shadow-xl">
                   {t("common.guaranteed_100")}
                 </div>
              </a>
              
              {/* WhatsApp Floating Overlay */}
              <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white rounded-full p-2 md:p-3 shadow-[0_20px_50px_rgba(37,211,102,0.5)] z-20 animate-bounce rtl:-left-auto rtl:-right-4 md:rtl:-right-6">
              ...
              <div className="absolute -top-4 -right-4 md:-top-6 md:-right-6 bg-gold text-emerald-950 p-3 md:p-5 rounded-full shadow-2xl z-20 border-4 border-emerald-900 rotate-12 group-hover:rotate-0 transition-transform duration-500 rtl:-right-auto rtl:-left-4 md:rtl:-left-6">
           ...
           <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-1 lg:order-2 flex-1 rtl:lg:text-right rtl:lg:items-end">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full border border-white/20 mb-6 backdrop-blur-md rtl:flex-row-reverse">
                <span className="w-2 h-2 bg-red-500 rounded-full animate-ping" />
                <span className="text-[10px] md:text-xs font-black text-white uppercase tracking-[0.2em]">{t("banner.immediate")}</span>
              </div>
              ...
              <div className="relative mb-6 md:mb-8 w-full">
                 ...
                 <div className="flex flex-col md:flex-row items-center lg:items-end gap-3 mt-1 rtl:flex-row-reverse rtl:lg:items-start">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-2 md:gap-3 mb-10 rtl:lg:justify-end">
                 {(Array.isArray(t("services.love_points")) ? (t("services.love_points") as string[]) : []).concat(["Husband Wife Conflict", "Breakup Resolution", "Stop Separation"]).map((service, idx) => (
                   <div key={idx} className="bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-xl flex items-center gap-2 group/item hover:bg-gold hover:border-gold transition-all cursor-default rtl:flex-row-reverse">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto rtl:flex-row-reverse">
                <a
                  href="tel:+919784412832"
                  className="w-full sm:w-auto bg-white hover:bg-gold text-emerald-950 px-10 py-4 rounded-2xl font-black text-lg shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3 group rtl:flex-row-reverse"
                >
                ...
                <a
                  ...
                  className="w-full sm:w-auto bg-[#25D366] hover:bg-white hover:text-[#25D366] text-white px-10 py-4 rounded-2xl font-black text-lg shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3 group border-2 border-white/10 rtl:flex-row-reverse"
                >
