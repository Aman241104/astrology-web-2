          ...
          {cards.map((card, idx) => (
            ...
            >
              ...
              <div className="p-8 md:p-10 pt-12 flex flex-col flex-grow bg-white text-center">
                ...
                <div className="mt-auto bg-[#25D366] md:hover:bg-emerald-950 text-white px-8 py-4 rounded-full font-black text-xs uppercase tracking-widest flex items-center justify-center gap-3 transition-all shadow-[0_15px_35px_rgba(37,211,102,0.3)] md:hover:shadow-emerald-900/30 group/btn">
