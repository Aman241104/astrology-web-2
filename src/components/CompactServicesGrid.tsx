...
import { Heart, Users, UserMinus, ShieldCheck, Zap, Star, Phone, ArrowRight, MessageCircle } from "lucide-react";
    ...
    <section id="services" className="py-12 md:py-24 bg-gray-50/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="relative group/scroll">
                 ...
                 <div className="p-6 md:p-10 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-4 md:pt-6 border-t border-emerald-50 flex items-center justify-between">
                      <div className="flex items-center gap-2 text-emerald-950 font-black text-[9px] md:text-xs uppercase tracking-widest group-hover:text-gold transition-colors">
                        ...
                        <span className="md:hidden inline">Chat Now</span>
                      </div>
          ...
          {/* Swipe Indicator */}
          <div className="flex md:hidden items-center justify-center gap-2 mt-4 text-gold animate-pulse">
            <span className="text-[10px] font-black uppercase tracking-widest">Swipe Right</span>
            <ArrowRight size={12} className="animate-bounce-x" />
          </div>
        </div>

        {/* Bottom Banner-style CTA */}
        <div className="mt-20 bg-gold p-8 md:p-16 rounded-[3rem] md:rounded-[4rem] text-center relative overflow-hidden shadow-2xl border-4 border-white/20">
           <div className="absolute inset-0 bg-arabesque opacity-5" />
           <div className="absolute -top-10 -left-10 opacity-20 transform rotate-45">
              <Star size={120} fill="currentColor" className="text-emerald-950" />
           </div>
           <div className="relative z-10">
              <h3 className="text-3xl md:text-6xl font-black text-emerald-950 uppercase tracking-tighter mb-4 leading-none">
                Need <span className="italic">Immediate</span> Help?
              </h3>
              <p className="text-emerald-900 font-black uppercase tracking-widest text-xs md:text-base mb-10 opacity-80 max-w-2xl mx-auto">
                Don't let love fade away. Get expert spiritual solutions for your relationship problems today. First consultation is free!
              </p>
              
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a 
                  href="https://wa.me/919784412832"
                  className="w-full sm:w-auto flex items-center justify-center gap-3 bg-emerald-950 text-white px-10 py-5 rounded-2xl font-black text-lg uppercase shadow-2xl hover:scale-105 transition-transform"
                >
                ...
                <a 
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white text-emerald-950 px-10 py-5 rounded-2xl font-black text-lg uppercase shadow-2xl hover:bg-emerald-50 transition-all border-b-4 border-gray-200"
                  style={{ direction: 'ltr' }}
                >
                  <Phone size={24} />
