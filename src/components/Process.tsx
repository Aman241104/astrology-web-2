    ...
    <section className="py-16 md:py-32 bg-emerald-950 text-white px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-20 text-center">
           <p className="text-gold font-bold uppercase tracking-[0.2em] text-xs mb-8">Ready to start your journey to happiness?</p>
           <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[#25D366] hover:bg-white text-white hover:text-[#25D366] px-10 py-5 rounded-2xl font-black text-lg transition-all shadow-2xl group"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-gold text-emerald-950 px-10 py-5 rounded-2xl font-black text-lg transition-all shadow-xl"
              >
                <PhoneCall size={22} />
