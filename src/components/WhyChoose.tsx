        ...
        <div className="flex-1 w-full max-w-md space-y-3">
          ...
          <div className="pt-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              ...
              <a href="https://wa.me/919784412832" className="bg-[#25D366] hover:bg-white hover:text-[#25D366] backdrop-blur-md px-6 py-2 rounded-full border border-white/20 transition-all text-white font-bold uppercase tracking-widest text-xs flex items-center gap-2 group">
