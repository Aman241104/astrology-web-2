      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-24">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-lg md:text-xl font-medium leading-relaxed italic">
            ...
            through the deep wisdom of the Holy Quran.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="group relative bg-white rounded-[2.5rem] border border-gray-100 transition-all duration-500 hover:shadow-[0_40px_100px_rgba(0,43,0,0.12)] hover:-translate-y-2 overflow-hidden flex flex-col h-full shadow-sm"
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/80 via-emerald-950/20 to-transparent opacity-60 group-hover:opacity-90 transition-opacity" />
                
                {/* Floating Icon */}
                <div className="absolute top-6 left-6 w-12 h-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-white border border-white/20 group-hover:bg-gold group-hover:text-emerald-950 transition-all duration-500 shadow-xl group-hover:rotate-[15deg]">
                  <service.icon size={24} />
                </div>

                <div className="absolute bottom-6 left-8 right-8">
                   <h3 className="font-serif text-2xl md:text-3xl font-black text-white leading-tight uppercase tracking-tighter group-hover:text-gold transition-colors">
                    {service.title}
                  </h3>
                </div>
              </div>
              ...
              <div className="p-8 md:p-10 flex flex-col flex-grow bg-white">
                ...
                <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                  <a
                    ...
                    className="inline-flex items-center space-x-3 font-black text-emerald-950 hover:text-[#25D366] transition-colors text-xs md:text-sm uppercase tracking-widest group/link"
                  >
                    <div className="bg-[#25D366] rounded-full p-1.5 shadow-md group-hover/link:scale-110 transition-transform flex items-center justify-center">
                  ...
                  <div className="w-10 h-10 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-900 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              {/* Corner Number */}
              <div className="absolute top-4 right-6 text-white/20 font-black text-4xl italic group-hover:text-gold/30 transition-colors">
                0{idx + 1}
              </div>
            </div>
          ))}
        ...
        {/* Global CTA Section */}
        <div className="mt-20 p-10 md:p-16 rounded-[3rem] bg-emerald-950 relative overflow-hidden shadow-2xl">
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="text-center lg:text-left max-w-2xl">
              <h3 className="text-3xl md:text-5xl font-serif font-black text-white mb-6 tracking-tighter leading-tight">
                Facing a unique challenge? <br /> Talk to <span className="text-gold italic">Arif Khan</span> Today.
              </h3>
              <p className="text-white/60 text-lg md:text-xl font-medium">
                Whatever your worry may be, there is always a solution in the Quran. Get a 100% confidential and free consultation.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 shrink-0">
              <a
                ...
                className="w-full sm:w-auto bg-gold hover:bg-white text-emerald-950 px-10 py-5 rounded-2xl font-black text-lg transition-all shadow-[0_20px_50px_rgba(212,175,55,0.3)] hover:scale-105 active:scale-95 flex items-center justify-center gap-3"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto bg-[#25D366] hover:bg-white hover:text-[#25D366] text-white px-10 py-5 rounded-2xl font-black text-lg transition-all shadow-xl hover:scale-105 active:scale-95 flex items-center justify-center gap-3 border border-white/10"
              >
