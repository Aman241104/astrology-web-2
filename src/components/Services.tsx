...
export default function Services() {
  return (
    <section id="services" className="py-16 md:pt-24 md:pb-12 bg-white px-4 relative overflow-hidden">
      {/* Background patterns */}
          ...
          {services.map((service, idx) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Floating Icon */}
                <div className="absolute top-6 left-6 w-12 h-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-white border border-white/20 md:group-hover:bg-gold md:group-hover:text-emerald-950 transition-all duration-500 shadow-xl md:group-hover:rotate-[15deg]">
              ...
              <div className="p-8 md:p-10 flex flex-col flex-grow bg-white">
                ...
                <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                  <div className="inline-flex items-center space-x-3 font-black text-emerald-950 md:group-hover:text-[#25D366] transition-colors text-xs md:text-sm uppercase tracking-widest group/link">
              ...
              {/* Corner Number */}
              <div className="absolute top-4 right-6 text-white/20 font-black text-4xl italic md:group-hover:text-gold/30 transition-colors">
                0{idx + 1}
              </div>
            </a>
          ))}
