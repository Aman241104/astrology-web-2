      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            <h3 className="font-serif text-2xl font-bold text-gold mb-6">Mohammed Arif Khan</h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+919784412832" className="hover:text-gold transition-colors">+91-9784412832</a>
              </li>
              <li className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-white/70 mb-6 leading-relaxed">
              Don't wait for your problems to grow. Call Mohammed Arif Khan now for an immediate solution.
            </p>
            <a
              href="https://wa.me/919784412832"
              className="flex items-center justify-center space-x-3 bg-[#25D366] hover:bg-white text-white hover:text-[#25D366] font-bold py-4 rounded-xl transition-all shadow-lg group"
            >
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-white/50 text-sm gap-4">
          <p>© {new Date().getFullYear()} Mohammed Arif Khan. All Rights Reserved.</p>
