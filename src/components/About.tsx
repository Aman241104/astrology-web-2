        ...
        <div className="flex-1 lg:pl-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-4 bg-[#25D366] hover:bg-emerald-950 text-white px-8 py-4 rounded-xl font-black text-lg shadow-2xl transition-all hover:scale-105 active:scale-95 group"
            >
